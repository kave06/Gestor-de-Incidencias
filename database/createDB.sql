...
CREATE TABLE IF NOT EXISTS assigned_technicians(
  ...
  PRIMARY KEY (incidence_id,username),
...
CREATE TABLE IF NOT EXISTS notifications(
  notification_id INT NOT NULL AUTO INCREMENT,
  incidence_id VARCHAR(15),
  origin_user VARCHAR(20),
  ...
  FOREIGN KEY (incidence_id) REFERENCES incidences(incidence_id),
  FOREIGN KEY (origin_user) REFERENCES users(username_id),
  FOREIGN KEY (target_user) REFERENCES users(username_id),
  FOREIGN KEY (status_id) REFERENCES type_of_status(status_id)
);
